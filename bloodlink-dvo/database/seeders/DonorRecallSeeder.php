    ...
    public function run(): void
    {
        ...
        $sampleDonors = [
            ...
            [
                ...
                'contact_number'     => '09943498630',
                'email'              => 'cristina.v@gmail.com',
                'blood_type'         => 'AB+',
                'donor_status'       => 'Regular',
                'registration_date'  => $today->copy()->subDays(350)->toDateString(),
                'last_donation_date' => $today->copy()->subDays(110)->toDateString(),
                'total_donations'    => 3,
                'remarks'            => 'Eligible donor',
            ],
            [
